<!----------------------------------------------footer---------------------------------------------------------->
    ...
    <!-- Svg Logo of social media icons -->
    ...
    <div class="container border-top mt-2">
      <footer class="py-5">
        <div class="row">
          <div class="col-4 col-md-3 mb-3">
            ...
            <ul class="nav flex-column">
              ...
              <li class="nav-item mb-2">
                <a href="index.php" class="nav-link p-0 text-muted">Products</a>
              </li>
              <li class="nav-item mb-2">
        ...
        >
          ...
          <!-- copyright -->
          <div class="col-4">
            <p class="pt-3 mb-0 text-muted">© 2023 Grapple, Inc. All rights reserved.</p>
          </div>
          ...
          <div class="col-4 d-flex justify-content-center">
            <p class="pt-3 mb-0">
              Made with
              <i class="fas fa-heart" style="color: rgb(190, 52, 85)" ;></i>
              in India
            </p>
          </div>
          ...
          <div class="col-4 d-flex justify-content-end">
            <ul class="list-unstyled d-flex pt-3 mb-0">
              <li class="ms-3">
