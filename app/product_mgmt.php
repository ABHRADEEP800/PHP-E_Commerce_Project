...
<body>
  ...
  <div class="container">
    ...
    <div class="pt-5">
      <form action="product_mgmt.php" method="GET">
      ...
      <div class="table-responsive">
        ...
        <table class="table" border="1">
          ...
          if (isset($_GET['search'])) {
            ...
            $result1 = $conn->query("SELECT count(product_id) AS product_id FROM product WHERE product_name LIKE '%$search%' OR product_description LIKE '%$search%' "); // Get the total number of entries from the database.
          ...
          ?>
            <tr>
              ...
              if ($status == 'Disable') {
              ?>
                <td><a onClick="if(confirm('are you want to enable this product ?')) window.location.href='enable_product.php?productId=<?php echo $id ?>';" class="btn btn-success">Enable</a></td>
              <?php
              } else {
              ?>
                <td><button onClick="if(confirm('are you sure to disable this product ?')) window.location.href='disable_product.php?productId=<?php echo $id ?>';" class="btn btn-danger">Disable</button></td>
              <?php
              }
              ?>
            </tr>
