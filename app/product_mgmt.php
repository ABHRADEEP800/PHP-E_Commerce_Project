    ...
    <div class="pt-5">
        <div class="d-flex pb-3">
            ...
            <div class="col-6 pe-3">
                <a href="add_product.php" class="btn btn-success float-end">Add Product</a>
            </div>
        </div>
        ...
        <table class="table" border="1" >
            ...
            if(isset($_POST['submit-search'])){
                ...
                $sql="SELECT * FROM product WHERE product_name LIKE '%$search%' OR product_description LIKE '%$search%' LIMIT $start, $limit";
            }
            else{
        ...
        <div class="d-flex">
            ...
            <div class="col-6 d-flex justify-content-end">
                <div class="">
                    ...
                    <li class=""><a class="page-link" href="product_mgmt.php?page=<?php echo $previous;?>">&laquo; Previous</a></li>
                    <?php for($i =1; $i<= $pages; $i++): ?>
                        
                    <li class=""><a class="page-link" href="product_mgmt.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>

                    <?php endfor; ?>
                    <li class=""><a class="page-link" href="product_mgmt.php?page=<?php echo $next;?>">&raquo; Next</a></li>
