                                ...
                                <div class="col-2">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="2fa" role="switch" id="flexSwitchCheckDefault" <?php
                                                                                                                                                $sql = "SELECT * FROM admin WHERE admin_email = '" . $_SESSION['admin'] . "'";
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE admin SET 2fa = '$twfa' WHERE admin_email = '" . $_SESSION['admin'] . "'";
    $result = mysqli_query($conn, $sql);
    if ($result) {
        echo "<script>
            ...
            //load container with jquery
            $('#container').load('twoFa.php #container');
            </script>";
    } else {
        echo "<script>
            toastr.options.closeButton = true;
