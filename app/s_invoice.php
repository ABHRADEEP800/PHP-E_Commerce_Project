...
<body>
  ...
  <div class="container text-center " style="padding:20px;">
    <div class="row">
      <div class="col-6 d-flex justify-content-start">
        ...
        <a href="s_omgmt.php" class="btn btn-primary"><i class="fas fa-arrow-left me-2"></i>Back</a>
  ...
  $sql = "SELECT  user.user_name, user.user_email, product.product_name, product.product_img, order_p.order_qu, product.product_price, orders.order_date, orders.order_status, orders.order_id, orders.discount,orders.shipping_address
      FROM orders
  ...
  if ($rowcount > 0) {
    ...
    echo "<script>window.location.href='./s_omgmt.php';</script>";
  }
        ...
        <div class="col-md-8">
          <div class="card">
            <div class="text-left logo p-2 px-5">
              <img src="asset\image\logo-bg.svg" width="100" />
            </div>
                ...
                <div class="product border-bottom table-responsive">
                  <table class="table table-borderless">
                    <tbody>
                      ...
                      INNER JOIN product ON product.product_id = order_p.order_item
                      WHERE order_p.order_id = '$order_id' AND  product.product_userid ='$user_id'";
                      $result = mysqli_query($conn, $sql);
